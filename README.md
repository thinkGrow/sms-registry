...
- **Students don't see their own fee balance, only staff do.** The Fee/Paid/Balance/installment breakdown/overdue badge is staff-only; a student viewing their own page just sees their payment history (a receipt of what they've paid) and the option to pay, without ever being shown how much they currently owe. This matches the same "no need to show how much he/she has" reasoning behind the online payment flow, applied consistently rather than just to that one dialog.
